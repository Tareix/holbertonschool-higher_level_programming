...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """Initialize a new Rectangle instance and increment count."""
        self.width = width
        self.height = height
    ...
    def __str__(self):
        ...
        Uses the `print_symbol` class/instance attribute.
        """
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        rect_1 must be an instance of Rectangle, otherwise raise TypeError.
        rect_2 must be an instance of Rectangle, otherwise raise TypeError.
